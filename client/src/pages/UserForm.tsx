    ...
    >
      <div className="space-y-2">
        ...
        <Input
          ...
          className="bg-accent/30 border-border/40 focus-glow transition-all duration-200"
      ...
      <div className="flex justify-end">
        <Button
          ...
          className="bg-gradient-to-r from-primary to-primary/85 shadow-lg shadow-primary/15"
        >
          {isEdit
