...
export default function TicketsFilters({
  ...
  return (
    <div className="flex items-center gap-3 mb-5 p-3 rounded-xl bg-card/60 border border-border/50">
      <div className="relative flex-1 max-w-sm">
        ...
        <Input
          ...
          className="pl-9 h-9 bg-accent/30 border-border/40 focus-glow transition-all duration-200"
        />
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        >
          <SelectTrigger className="w-[150px] h-9 bg-accent/30 border-border/40">
        ...
        >
          <SelectTrigger className="w-[180px] h-9 bg-accent/30 border-border/40">
